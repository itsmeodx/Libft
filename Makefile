...
objects = ft_atoi.o ft_bzero.o ft_calloc.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
          ...
          ft_memmove.o ft_memset.o ft_putchar_fd.o ft_putchar.o ft_putendl_fd.o ft_putnbr_fd.o ft_putnbr.o \
          ft_putnbr_base.o ft_putstr_fd.o ft_putstr.o ft_split.o ft_strchr.o ft_strdup.o ft_striteri.o ft_strjoin.o \
